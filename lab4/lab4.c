...
void print_change(int twenties, int tens, int fives, int ones, int quarters, int dimes, int nickles, int pennies);
...
int main(){
    ...
    */
    ...
    // identify self
    program_identification("Ben Fasick", "September 28th 2021");

    // get amount to gibe in change
